...
There are a handful of different APIs that you can pick and choose from based on your app's functionality and which Discord features you want to access. Below is a quick overview of the main APIs on the Discord developer platform. You can read more details and information about API usage in the [API reference](/developers/reference).
...
<CardGroup cols={3}>
  <Card title="Bots & Companion Apps" href="/developers/bots/overview" icon="robot">
    Build a bot that responds to events, commands, and user interactions in Discord servers.
  </Card>
  <Card title="Social Layer for Games" href="/developers/discord-social-sdk/overview" icon="gamepad-2">
    Add Discord-powered social features to your game using the Discord Social SDK.
  </Card>
  <Card title="Activities" href="/developers/activities/overview" icon="shapes">
