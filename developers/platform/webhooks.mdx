...
<CardGroup cols={2}>
  <Card title="Webhook resource reference" href="/developers/resources/webhook" icon="inbox" horizontal>
    Full API reference for incoming webhook endpoints and objects.
  </Card>
  <Card title="Webhook events" href="/developers/events/webhook-events" icon="inbox" horizontal>
