...
<Note>
  Modals can only be opened in response to an interaction — you cannot proactively open a modal for a user without a preceding interaction trigger.
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="Using modal components" href="/developers/components/using-message-components">
