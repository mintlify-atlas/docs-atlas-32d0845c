...
<Warning>
  Never share your bot token or check it into version control. If your token is compromised, regenerate it immediately from the Developer Portal.
</Warning>
...
<Tip>
  Your app should request only the permissions it needs. Requesting excessive permissions reduces trust with users and is against Discord's [Developer Policy](https://support-dev.discord.com/hc/en-us/articles/8563934450327-Discord-Developer-Policy).
</Tip>
